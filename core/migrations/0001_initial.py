# Generated by Django 2.1.3 on 2018-11-25 14:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aduren_reel_vimeo_url', models.URLField(blank=True, null=True, verbose_name='Aduren Reel Vimeo URL')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('google_maps_embed_html', models.TextField(blank=True, null=True, verbose_name='google maps embeded html')),
